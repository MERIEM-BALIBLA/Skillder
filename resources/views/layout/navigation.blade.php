		...
		<ul class="hidden absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 lg:flex lg:mx-auto lg:flex lg:items-center lg:w-auto lg:space-x-6">
			...
			<li class="text-gray-300">
             ...
             @if(auth()->check() && !auth()->user()->hasRole('apprenant'))
                <li>
                    <a href="/company" class="text-sm text-gray-400 hover:text-gray-500">
            ...
            <div class="flex">
                @guest
                    @if (Route::has('register'))
                        <a class="lg:inline-block lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold rounded-xl transition duration-200" href="{{ route('register') }}">{{ __('Register') }}</a>
                    @endif
                    @if (Route::has('login'))
                        <a class="lg:inline-block lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold rounded-xl transition duration-200" href="{{ route('login') }}">{{ __('Login') }}</a>
                        @endif
                    @else 
                        <a class="lg:inline-block lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold rounded-xl transition duration-200" href="{{ route('logout') }}"
